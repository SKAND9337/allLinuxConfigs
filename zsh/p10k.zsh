# Generated by Powerlevel10k configuration wizard on 2026-05-27 at 22:23 IST.
...
# angled separators, blurred heads, slanted tails, 2 lines, dotted, right frame,
...
() {
  ...
  # Arch/Cachy logo instead of penguin
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION=''

  # Dark icon for readability on bright themes
